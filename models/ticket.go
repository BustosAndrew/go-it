...
type Ticket struct {
	...
	TranscriptString string       `json:"transcript_string,omitempty" firestore:"transcript_string,omitempty"` // Full transcript as a formatted string
	Summary          string       `json:"summary,omitempty" firestore:"summary,omitempty"`
	Suggestions      []Suggestion `json:"suggestions,omitempty" firestore:"suggestions,omitempty"`
}
